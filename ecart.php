            ...
            <div class="row decor_bg">
                <div class="col-md-6 col-md-offset-3">
                    ...
                    <br><br><br><br>
                        ...
                        $query = "SELECT items.price AS Price, items.id, items.name AS Name FROM users_items JOIN items ON users_items.item_id = items.id WHERE users_items.user_id='$user_id' and status='download'";
                        ...
                        if (mysqli_num_rows($result) >= 1) {
                            ...
                            <tbody>
                                ...
                                $id = rtrim($id, ", ");
                                echo "<tr><td></td><td>Total</td><td>Rs " . $sum . "</td><td><a href='esuccess.php?itemsid=" . $id . "' class='btn btn-primary'>Pay with Paypal</a></td></tr>";
                                ?>
                            </tbody>
                            <?php
                        } else {
