            ...
            <div class="row decor_bg">
                <div class="col-md-6 col-md-offset-3">
                    ...
                    <br><br><br><br>
                        ...
                        $query = "SELECT items.price AS Price, items.id, items.name AS Name FROM users_items JOIN items ON users_items.item_id = items.id WHERE users_items.user_id='$user_id' and status='buy'";
