...
<html>
<head>
  <title>BookWorm | Historical Fiction</title>
...
<body>
     ...
     <div class="panel panel-success" style="margin-bottom: 0px; margin-top: 45px;">
      <div class="panel-heading">
         <a href="#"><h4 style="color: #000000"><strong>HISTORICAL FICTION</strong></h4></a>
      </div>
  <form>
     <div class="container" style="margin-bottom: 50px; margin-top: 40px;">
      ...
      <div class="col-md-3 col-sm-6" style="margin-right: 80px; margin-left: 60px;" >
       <a href="#" class="thumbnail" style="height: 300px;"><img src="images/history/catch.jpg" alt="Responsive Image">
        ...
        <p><a href="book.php?id=42" role="button" class="btn btn-primary btn-block">Read Now</a></p>
      </div>
        ...
        <a href="#" class="thumbnail" style="height: 300px;" ><img src="images/history/gone.jpg" alt="Responsive Image">
            ...
            <p><a href="book.php?id=43" role="button" class="btn btn-primary btn-block">Read Now</a></p>
        </div>

        <div class="col-md-3 col-sm-6">
        <a href="#" class="thumbnail" style="height: 300px;"><img src="images/history/war.jpg" alt="Responsive Image">
        </a>
               <p><a href="book.php?id=44" role="button" class="btn btn-primary btn-block">Read Now</a></p>
        </div> 
